 ...
 void frontscreen(void)
{
	...
	glEnd();
	glColor3f(1,0,0);
	output(40,90,"Tejas and Shravan ");
...
output(50,100,"1.EASY GAME");
output(50,80,"2.HARD GAME");
output(50,60,"3.INSTRUCTIONS");
output(50,40,"4.QUIT");
glFlush();
}
...
void SpecialKey(int key, int x, int y)
{
  switch (key)
  {
	...
	case GLUT_KEY_RIGHT:
        ...
        wall(128,140,128,180,132,180,132,140);


		if(!((px>=125 && px<=158) && (py>=128 && py<=132)))
...
//wall(-4,270,-4,270,0,162,-4,162);

wall(180,178,184,178,184,178,180,178);
//wall(180,170,180,166,-4,166,0,170);
wall(72,102,72,98,78,98,78,102);
	...
	/*	wall(72,102,72,72,68,72,68,102);
		...
		wall(98,108,112,108,112,112,98,112);
		wall(58,152,58,128,62,128,62,152);
		wall(88,118,88,100,92,98,92,118);
...
wall(120,178,120,178,124,178,124,178);
wall(-4,98,-4,104,184,104,184,98);

wall(-4,98,-4,180,0,180,-0,98);


wall(186,98,186,180,180,180,180,98);
